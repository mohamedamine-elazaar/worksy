      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        <div className="bg-indigo-600 text-white rounded-xl p-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            <Link to="/register" className="px-4 py-2 bg-white text-indigo-700 rounded-md font-semibold">Create account</Link>
...
export default function Dashboard() {
  const hasAccount = (function(){
    try {
      return !!(typeof localStorage !== 'undefined' && localStorage.getItem('account'))
    } catch { return false }
  })()
  return (
